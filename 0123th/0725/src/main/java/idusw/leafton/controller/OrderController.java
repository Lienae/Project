...
public class OrderController {
    ...
    //바로 구매하기로 주문시
    @GetMapping(value = "/buy/one/{memberId}/{cartItemId}")
    public String goBuyOne(@PathVariable("memberId") Long memberId, @PathVariable("cartItemId") Long cartItemId, Model model){
        MemberDTO member = memberService.getMemberById(memberId);

        if(member != null) {
            CartItemDTO cartOneItemById = cartService.findCartItemById(cartItemId);
